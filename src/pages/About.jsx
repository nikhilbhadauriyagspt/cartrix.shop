    ...
    <div className="min-h-screen bg-gray-50  text-gray-900 ">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="lg:pl-16">
              <div className="relative h-96 w-full rounded-2xl overflow-hidden shadow-2xl bg-primary-100  border border-primary-200  transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <img
      ...
      <section className="py-16 md:py-24 bg-white ">
        ...
        ">
          ...
          ">
              <div className="
              p-4 rounded-full bg-indigo-100 
              text-indigo-600 
              mb-6
              shadow-md
            ">
          ...
          ">
              {/* Value Card 1 */}
              <div className="
              flex flex-col items-center p-6 rounded-xl shadow-md border border-gray-100 
              bg-gray-50 
              hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 ease-in-out
            ">
                <div className="
                p-3 rounded-full bg-emerald-100 
                text-emerald-600 
                mb-4
              ">
                  <Gem size={28} />
            ...
            ">
                <div className="
                p-3 rounded-full bg-purple-100 
                text-purple-600 
                mb-4
              ">
                  <Eye size={28} />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="p-4">
              ...
              <p className="text-lg text-gray-700 ">Brands Offered</p>
            </div>
          </div>
        </div>
      </section>
